...
const Writing: React.FC = () => {
  ...
  const handleStartLearning = () => {
    if (localSelectedTopic) {
      ...
      navigate(`/learn/writing/${localSelectedTopic.id}`);
    }
  };
    ...
    <div className="min-h-screen bg-[var(--bg-primary)] p-4 md:p-8">
      <div className="max-w-4xl mx-auto space-y-6">
        <div className="text-center mb-8">
          <h1 className="text-4xl font-bold mb-2 text-[var(--text-primary)]">Writing Practice</h1>
          <p className="text-[var(--text-secondary)]">Luyện tập viết với các chủ đề TOEIC</p>
        </div>
